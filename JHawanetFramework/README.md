...
Este software permite la soluci贸n de problemas relacionados a redes de distribuci贸n de agua potable. Los problemas que el programa incluye por defecto son
...
1. Instalar maven. Una guia de como instalarlo puede encontrarla [aqu铆](hhttps://maven.apache.org/index.html)
2. Una vez maven este instalado, hay que agregar el jar de la EpanetTolkit requerido para la simulaci贸n al repositorio de maven. Para esto ejecute el siguiente comando: 
...
mvn clean package
``` 
4. Despues de terminar la ejecuci贸n del comando el lanzador se encontrara en target/jfx/
...
### Nota2: La version en ingles y la version en espa駉l de epanet a veces ocupan distintas palabras claves (Ej: Feet en ingles y Pies en espa駉l). Este programa lee el formato inp de la version en ingles.
