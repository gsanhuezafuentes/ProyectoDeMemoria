package controller.multiobjective;
...
public class MultiObjectiveRunningWindowController {
    ...
    public MultiObjectiveRunningWindowController(@NotNull Experiment<?> experiment, @Nullable Map<String, String> parameters, @NotNull Network network, @NotNull Consumer<ResultController> callback) {
        ...
        this.root = ControllerUtils.loadFXML("/view/multiobjective/MultiObjectiveRunningWindow.fxml", this); //initialize root and @FXML by injection
