...
public interface IEpanetNative extends Library {
	...
	public interface pviewprog extends Callback {
	 ...
	 * ENepanet is a stand-alone function and does not interact with any of the
	 * other functions in the toolkit. <br>
	 * <br>
	 * 
	 ...
	 * <br>
	 * 
	 * The vfunc function pointer allows the calling program to display a progress
	 * message generated by EPANET during its computations. A typical function for a
	 * console application might look as follows: <br>
	 * <br>
	 * 
	 * <code>
	 *  void  writecon(char *s){ <br>   
			&nbsp; puts(s);  <br> 
		}   <br> 
	 ...
	 * <br>
	 * <br>
	 * and somewhere in the calling program the following declarations would
	 * appear:<br>
	 * <br>
	 * 
	 * <code>
	 * 	void (* vfunc) (char *);  <br> 
		vfunc = writecon;  <br> 
		ENepanet(f1,f2,f3,vfunc); <br> 
	 * </code><br>
	 * <br>
	 * 
	 * If such a function is not desired then this argument should be null <br>
	 * <br>
	 * 
	 * ENepanet is used mainly to link the EPANET engine to third-party user
	 * interfaces that build network input files and display the results of a
	 * network analysis.
	 * 
	 * 
	 ...
	 * @param callback pointer to a user-supplied function which accepts a character
	 *                 string as its argument.
	 * @return Returns an error code.
	 */
	int ENepanet(String f1, String f2, String f3, pviewprog callback);
	 ...
	 * number of tanks and reservoirs.<br>
	 * <br>
	 * 
	 ...
	 * 
	 * @param errcode error or warning code
	 * @param errmsg  text of the error or warning message for errcode
	 * @param nchar   maximum number of characters that errmsg can hold
	 * @return Returns an error code.
	 */
	 ...
	 * 
	 * @param index    link index
	 * @param fromnode index of node at start of link
	 * @param tonode   index of node at end of link
	 * @return Returns an error code.
	 */
	 ...
	 * 
	 * @param index    time pattern index
	 * @param factors  multiplier factors for the entire pattern (The buffer as to
	 *                 contain float element).
