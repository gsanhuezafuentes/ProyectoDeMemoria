...
\begin{itemize}
    ...
    \item El sistema inicialmente únicamente contara con dos algoritmos implementados los cuales serán el algoritmo genético y NSGAII. El algoritmo genético será el usado para tratar el problema monoobjetivo, mientras que NSGAII será aplicado al multiobjetivo.
\end{itemize}
