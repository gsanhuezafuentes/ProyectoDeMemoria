...
Esta anotación permite indicar el nombre del problema que es mostrado en la interfaz gráfica. Puedes ver el uso de esta anotación en la Figura \ref{fig:constructor_heredado_registrable}.
