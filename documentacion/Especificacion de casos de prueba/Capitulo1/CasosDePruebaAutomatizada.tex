...
En este capitulo se presenta la especificación formal de los casos de prueba automatizados.
...
\begin{prueba}
    \TestID{\atcounter}
    \Titulo{Envio de parámetro invalido al método setProperty de la clase \textit{Pump} cuando se usa la clave \textit{PumpProperty.HEAD}.}
    \Caracteristica{Validar parametro recibido por el método \textit{setProperty}.}
    \Objetivo{Comprobar que si se pasa un parametro como valor de un tipo distinto a \textit{String}, cuando se usa la clave \textit{PumpProperty.HEAD}, el método lanza una excepción.}
    \Configuracion{Instancia de la clase \textit{Pump} inicializada.}
    \DatosPrueba{%
    Clave: \textit{PumpProperty.HEAD}\\
    Value: Un objeto diferente a un \textit{String}
    }
    \AccionesPrueba{%
    ...
    \ResultadosEsperados{Excepción indicando que el tipo de instancia pasada no es valida.}
\end{prueba}

\begin{prueba}
    \TestID{\atcounter}
    \Titulo{Envio de parámetro invalido al método setProperty de la clase \textit{Pump} cuando se usa la clave \textit{PumpProperty.PATTERN}.}
    \Caracteristica{Validar parametro recibido por el método \textit{setProperty}.}
    \Objetivo{Comprobar que si se pasa un parametro como valor de un tipo distinto a \textit{String}, cuando se usa la clave \textit{PumpProperty.PATTERN}, el método lanza una excepción.}
    \Configuracion{Instancia de la clase \textit{Pump} inicializada.}
    \DatosPrueba{%
...
\begin{prueba}
    \TestID{\atcounter}
    \Titulo{Envio de parámetro invalido al método setProperty de la clase \textit{Pump} cuando se usa la clave \textit{PumpProperty.SPEED}.}
    \Caracteristica{Validar parametro recibido por el método \textit{setProperty}.}
    \Objetivo{Comprobar que si se pasa un parametro como valor de un tipo distinto a \textit{Double}, cuando se usa la clave \textit{PumpProperty.SPEED}, el método lanza una excepción.}
    \Configuracion{Instancia de la clase \textit{Pump} inicializada.}
    \DatosPrueba{%
    Clave: \textit{PumpProperty.SPEED}\\
    Value: Un \textit{Integer} o alguna instancia de otro objeto distinto de Double.
    }
    \AccionesPrueba{%
        1. Inicializar instancia.\\
...
\begin{prueba}
    \TestID{\atcounter}
    \Titulo{Envio de parámetro invalido al método setProperty de la clase \textit{Pump} cuando se usa la clave \textit{PumpProperty.POWER}.}
    \Caracteristica{Validar parametro recibido por el método \textit{setProperty}.}
    \Objetivo{Comprobar que si se pasa un parametro como valor de un tipo distinto a \textit{Double}, cuando se usa la clave \textit{PumpProperty.POWER}, el método lanza una excepción.}
    \Configuracion{Instancia de la clase \textit{Pump} inicializada.}
    \DatosPrueba{%
...
\begin{prueba}
    \TestID{\atcounter}
    \Titulo{Envio de parámetro válido al método setProperty de la clase \textit{Pump} cuando se usa la clave \textit{PumpProperty.HEAD}.}
    \Caracteristica{Validar parametro recibido por el método \textit{setProperty}.}
    \Objetivo{Comprobar que si se pasa un parametro de tipo \textit{String} como valor, cuando se usa la clave \textit{PumpProperty.HEAD}, el método finaliza sin error.}
    \Configuracion{Instancia de la clase \textit{Pump} inicializada.}
    \DatosPrueba{%
    Clave: \textit{PumpProperty.HEAD}\\
    Value: Un \textit{String} no vacío.
    }
    \AccionesPrueba{%
        1. Inicializar instancia.\\
...
\begin{prueba}
    \TestID{\atcounter}
    \Titulo{Envio de parámetro válido al método setProperty de la clase \textit{Pump} cuando se usa la clave \textit{PumpProperty.PATTERN}.}
    \Caracteristica{Validar parametro recibido por el método \textit{setProperty}.}
    \Objetivo{Comprobar que si se pasa un parametro de tipo \textit{String} como valor, cuando se usa la clave \textit{PumpProperty.PATTERN}, el método finaliza sin error.}
    \Configuracion{Instancia de la clase \textit{Pump} inicializada.}
    \DatosPrueba{%
    Clave: \textit{PumpProperty.PATTERN}\\
    Value: Un \textit{String} no vacío.
...
\begin{prueba}
    \TestID{\atcounter}
    \Titulo{Envio de parámetro válido al método setProperty de la clase \textit{Pump} cuando se usa la clave \textit{PumpProperty.SPEED}.}
    \Caracteristica{Validar parametro recibido por el método \textit{setProperty}.}
    \Objetivo{Comprobar que si se pasa un parametro de tipo \textit{Double} como valor, cuando se usa la clave \textit{PumpProperty.SPEED}, el método finaliza sin error.}
    \Configuracion{Instancia de la clase \textit{Pump} inicializada.}
    \DatosPrueba{%
    Clave: \textit{PumpProperty.SPEED}\\
    Value: Un valor \textit{Double}.
    }
    \AccionesPrueba{%
        1. Inicializar instancia.\\
...
\begin{prueba}
    \TestID{\atcounter}
    \Titulo{Envio de parámetro válido al método setProperty de la clase \textit{Pump} cuando se usa la clave \textit{PumpProperty.POWER}.}
    \Caracteristica{Validar parametro recibido por el método \textit{setProperty}.}
    \Objetivo{Comprobar que si se pasa un parametro de tipo \textit{Double} como valor, cuando se usa la clave \textit{PumpProperty.POWER}, el método finaliza sin error.}
    \Configuracion{Instancia de la clase \textit{Pump} inicializada.}
    \DatosPrueba{%
    Clave: \textit{PumpProperty.POWER}\\
    Value: Un valor \textit{Double}.
...
\begin{prueba}
    \TestID{\atcounter}
    \Titulo{Deshabilitar número máximo de evaluaciones sin mejoras cuando se modifica el numero máximo de evaluaciones.}
    \Caracteristica{Validar parámetro \textit{maxEvaluations}.}
...
\begin{prueba}
    \TestID{\atcounter}
    \Titulo{Deshabilitar número máximo de evaluaciones cuando se modifica el numero máximo de evaluaciones sin mejoras.}
    \Caracteristica{Validar parámetro \textit{maxNumberOfEvaluationsWithoutImprovement}.}
...
\begin{prueba}
    \TestID{\atcounter}
    \Titulo{Probabilidad de mutación no valida.}
...
\begin{prueba}
    ...
    \ResultadosEsperados{Las variables en la solución despues de realizar la mutación debe ser [2, 0, 4] }
\end{prueba}
...
\begin{prueba}
    ...
    \ResultadosEsperados{Las variables en la solución despues de realizar la llamada al método \textit{execute} debe ser los valores originales [0, 2, 4].}
\end{prueba}
...
\begin{prueba}
    ...
    \Objetivo{Validar que la mutación no sucede si el \textit{range} tiene el valor 0.}
    \Configuracion{%
    Solucion con variables preestablecidas.\\
    Operador \textit{IntegerRangeRandomMutation} inicializado.
    }
...
\begin{prueba}
    ...
    \Caracteristica{Validar las anotaciones y el tipo de parámetros utilizados en el constructor de la clase \textit{Registrable}.}
    \Objetivo{Validar si en el constructor público tiene ni la anotación \textit{@NewProblem}}
    \Configuracion{%
...
\begin{prueba}
    ...
    \Caracteristica{Validar las anotaciones y el tipo de parámetros utilizados en el constructor de la clase \textit{Registrable}.}
    \Objetivo{Validar que el constructor público con las anotaciones recibe los parametros en el siguiente orden: \textit{Object}, \textit{File}, \textit{(int \vb Integer \vb double \vb Double)}.}
    \Configuracion{%
        Implementación de \textit{Registrable} con las anotaciones \textit{@NewProblem} y \textit{@Parameters}, y con los parámetros recibidos en el orden esperado.
    }
    \DatosPrueba{%
        Objeto \textit{Class$<$?$>$} que referencia al tipo \textit{Registrable}.
    }
...
\begin{prueba}
    ...
    \Caracteristica{Validar las anotaciones y el tipo de parámetros utilizados en el constructor de la clase \textit{Registrable}.}
    \Objetivo{Validar que el constructor público con las anotaciones recibe los parametros en un orden distinto a: \textit{Object}, \textit{File}, \textit{(int \vb Integer \vb double \vb Double)}.}
    \Configuracion{%
        Implementación de \textit{Registrable} con las anotaciones \textit{@NewProblem} y \textit{@Parameters}, y con los parámetros recibidos en un orden distinto al especificado.
    }
    \DatosPrueba{%
        Objeto \textit{Class$<$?$>$} que referencia al tipo \textit{Registrable}.
    }
...
\begin{prueba}
    ...
    \Configuracion{%
        Implementación de \textit{Registrable} las anotaciones \textit{@NewProblem} y \textit{@Parameters}. El elemento \textit{numberToggle} de \textit{@Parameters} tiene las anotaciones \textit{@NumberToggleInput} con el mismo \textit{groupID} juntos.
    }
    \DatosPrueba{%
        Objeto \textit{Class$<$?$>$} que referencia al tipo \textit{Registrable}.
    }
...
\begin{prueba}
    ...
    \Configuracion{%
        Implementación de \textit{Registrable} las anotaciones \textit{@NewProblem} y \textit{@Parameters}. El elemento \textit{numberToggle} de \textit{@Parameters} no tiene las anotaciones \textit{@NumberToggleInput} con el mismo \textit{groupID} juntos.
    }
    \DatosPrueba{%
        Objeto \textit{Class$<$?$>$} que referencia al tipo \textit{Registrable}.
    }
...
\begin{prueba}
    ...
    \Configuracion{%
        Implementación de \textit{Registrable} las anotaciones \textit{@NewProblem} y \textit{@Parameters}. El constructor indica que recibirá un \textit{File} mientras que la anotación \textit{@Parameters} indica que en esa posición debería recibirse un \textit{Object}, el cual hace referencia a un operador de la metaheurística.
    }
    \DatosPrueba{%
        Objeto \textit{Class$<$?$>$} que referencia al tipo \textit{Registrable}.
    }
...
\begin{prueba}
    ...
    \Caracteristica{Validar que la clase abstracta guarda el parametro \textit{timeInSeconds} correctamente.}
...
\begin{prueba}
    ...
    \ResultadosEsperados{El entero leido desde el json con clave ``\textit{int}''.}
\end{prueba}

\begin{prueba}
    \TestID{\atcounter}
    \Titulo{Leer un numero decimal (\textit{double}) desde un json.}
    \Caracteristica{Leer valores desde un json.}
    ...
    \ResultadosEsperados{El double leido desde el json con clave ``\textit{double}''.}
\end{prueba}
...
\begin{prueba}
    ...
    \ResultadosEsperados{El boleano leido desde el json con clave ``\textit{boolean}''.}
\end{prueba}
...
\begin{prueba}
    ...
    \ResultadosEsperados{El arreglo de enteros desde el json con clave ``\textit{ints}''.}
\end{prueba}
...
\begin{prueba}
    ...
    \ResultadosEsperados{El arreglo de valores decimales leido desde el json con clave ``\textit{doubles}''.}
\end{prueba}
...
\begin{prueba}
    ...
    \ResultadosEsperados{La matriz de valores enteros leido desde el json con clave ``\textit{intMatrix}''.}
\end{prueba}
...
\begin{prueba}
    ...
    \ResultadosEsperados{La matriz de valores decimales leido desde el json con clave ``\textit{doubleMatrix}''.}
\end{prueba}
