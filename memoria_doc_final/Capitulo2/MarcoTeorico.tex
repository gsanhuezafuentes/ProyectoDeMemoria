...
Para el desarrollo de este proyecto se opto por la metodología iterativa e incremental. La elección de esta metodología se debe al hecho de que este genera suficiente documentación para ser utilizada en el desarrollo de futuros proyectos derivados de este trabajo.
\subsection{Metodología iterativa e incremental}
El desarrollo iterativa e incremental es una metodología la cual lleva a cabo el desarrollo de un proyecto de software dividiéndolo en iteraciones que generan un incremento, el cual contribuye en el desarrollo del producto final.
...
\begin{figure}[h]
	\includegraphics{Capitulo2/iedevelopment.eps}
	\centering
	\caption{Metodología iterativa e incremental \cite{Pressman2009}}
	\label{fig:methodie}
\end{figure}

El hecho de llevar a cabo un desarrollo iterativa permite la obtención de retroalimentación del producto que se esta desarrollando tempranamente y de esta manera poder refinar el trabajo en etapas posteriores del desarrollo. \cite{Victor2003, Mitchell2009, Martin1999,Alshamrani2015}.
...
\begin{figure}[h]
	 \includegraphics{Capitulo2/componentesfisicosred.eps}
	\centering
...
\begin{figure}[h]
	 \includegraphics{Capitulo2/dominancia.eps}
	\centering
...
\begin{figure}[h]
	 \includegraphics{Capitulo2/frontera-pareto.eps}
	\centering
...
\begin{figure}[h]
	 \includegraphics{Capitulo2/ProcedimientoNSGA-II.eps}
	\centering
...
\begin{figure}[h]
	 \includegraphics{Capitulo2/frentes-no-dominados.eps}
	\centering
...
\begin{figure}[h]
	\includegraphics[scale=0.8]{Capitulo2/crowing-distance.eps}
	\centering
