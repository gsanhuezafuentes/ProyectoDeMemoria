...
\begin{itemize}
	...
	\item Definición de características a evaluar: Consiste en establecer qué es lo que estamos interesados en evaluar del elemento sobre el que se aplica el caso de estudio.
