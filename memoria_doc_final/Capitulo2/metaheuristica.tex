...
\begin{itemize}
	\item \textbf{Cruce:} El cruzamiento es un mecanismo usado para generar nuevos soluciones a partir de dos o mas individuos seleccionados~\cite{Blum2003, Boussaid2013}.
	
	\item \textbf{Mutación:} La mutación es un operador el cual permite mantener la diversidad en la descendencia~\cite{Boussaid2013} realizando modificaciones en ciertas partes de la solución.
\end{itemize}
...
Dentro de los algoritmos evolutivos más utilizados se encuentran el Algoritmo Genético, ............
...
% Uno de los algoritmos evolutivos mas conocidos es el Algoritmo Genético.
