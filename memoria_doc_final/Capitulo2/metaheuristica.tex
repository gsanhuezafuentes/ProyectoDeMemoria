...
El Algoritmo Genético es uno de los algoritmos evolutivos más conocidos y que ha demostrado ser exitoso en una variedad de problemas diferentes. Estos algoritmo hacen uso de los mecanismos de selección y reproducción para generar nuevas soluciones a partir de la combinación de otras~\cite{Heiss-Czedik1997}.
