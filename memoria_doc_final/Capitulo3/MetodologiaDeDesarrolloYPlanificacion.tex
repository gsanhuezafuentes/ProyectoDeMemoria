...
\paragraph{Análisis:}
\begin{itemize}
	\item Captura de requisitos: Durante esta etapa se reúne con el cliente ya sea física o de remotamente y se conversa y llega a un acuerdo acerca de las funcionalidades que deben ser implementadas en la aplicación.
