...
\begin{longtable}{||c| m{10cm}||}
  ...
  \hline
  4 & Se agrega el algoritmo NSGAII. \newline Se implementa la codificación del problema multiobjetivo \textbf{Pumping Schedule}.\\
  \hline
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{Capitulo4/assets/VisualizacionRed.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{Capitulo4/assets/ConfiguracionProblema1.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{Capitulo4/assets/ConfiguracionProblema2.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{Capitulo4/assets/ConfiguracionProblema3.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{Capitulo4/assets/VentanaDeEjecucionMono.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{Capitulo4/assets/VentanaDeResultadosMono.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{Capitulo4/assets/VentanaDeSimulacionHidraulica.png}
	\caption{Ventana de simulación hidráulica utilizando los valores del archivo de red}
	\label{fig:ventana_simulacion_hyd}
\end{figure}

A continuación se muestra el constructor de utilizado en el \textit{template} para el problema \textit{Pipe Optimizing}. Este constructor, el cual se muestra en la Figura~\ref{fig:constructor}, genera la interfaz mostrada en la Figura~\ref{fig:ventana_descripcion} y \ref{fig:ventana_configuracion_problema}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.90\textheight, angle=90]{Capitulo4/assets/ConstructorHeredadoRegistrablev2.png}
    \caption{Uso de anotaciones en la clase que hereda \textit{Registrable} para construir la interfaz de configuración del problema}
