...
Como se menciono en el capítulo anterior, para llevar a cabo el desarrollo del proyecto se opto por la metodología iterativa e incremental. La planificación resultante seguida durante el desarrollo del proyecto se muestra en el Cuadro~\ref{fig:planificacion}.
